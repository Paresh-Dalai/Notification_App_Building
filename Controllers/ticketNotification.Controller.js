...
const ticketNotificationModel = require('./../Models/ticketNotification')
...
const getNotification = async (req,res) => {
    ...
    try {
        let ticket = await ticketNotificationModel.find({_id : req.params.id});
        if (ticket) {
...
module.exports = { acceptNotificationRequest, getNotification }